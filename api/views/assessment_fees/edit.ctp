...
<?php echo $this->Form->create('AssessmentFee');?>
	<fieldset>
		<legend><?php __('Edit Assessment Fee'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('AssessmentFee.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('AssessmentFee.id'))); ?></li>
