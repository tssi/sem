<div class="channels index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('base_url');?></th>
			<th><?php echo $this->Paginator->sort('endpoint');?></th>
	...
	<tr<?php echo $class;?>>
		...
		<td><?php echo $channel['Channel']['base_url']; ?>&nbsp;</td>
		<td><?php echo $channel['Channel']['endpoint']; ?>&nbsp;</td>
