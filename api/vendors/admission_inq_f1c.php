...
class AdmissionInquiryForm1C extends Formsheet{
	protected static $_width = 14;
	protected static $_height = 8.5;
	protected static $_unit = 'in';
	protected static $_orient = 'P';	
	protected static $_fields = null;	
	protected $_docName = 'Admission INQ Form 1C (AIF-F1C)';	
	protected $_docTitle = 'APPLICATION FOR ADMISSION';	
	protected static $_docSY = 'School Year 2024 - 2025';	
	protected static $_docVersion = 'Version 1.0';	
	...
	function hdr(){
		...
		$this->rightText(24,1,$this->_docName,10.5,'b');
		$this->GRID['font_size']=9;
		
		$this->rightText(40,2.5,AdmissionInquiryForm1C::$_docSY,10,'');
		$this->rightText(40,3.75,AdmissionInquiryForm1C::$_docVersion,8.5,'i');
		$this->GRID['font_size']=14;
		$this->centerText(1,6,$this->_docTitle,50,'b');
	...
	function info($student=null,$showInstruction=true){
		$metrics = array(
			'base_x'=> 0.25,
			'base_y'=> 1.8,
			'width'=> 8,
		...
		$note = '                           Kindly  WRITE  LEGIBLY IN  PRINT  when completing the form to ensure accurate  processing of your admission. Some information has already been filled out from your initial inquiry. If there are any corrections indicate the changes for updating.';
		if($showInstruction):
		...
		$fields = $this->setUpData($fields,$student);
	...
	function setupFields(){
		$timestamp = 'Date Generated: '.date('d M Y h:i:a');
		AdmissionInquiryForm1C::$_fields = array(
				...
				array('label'=>'Date of Birth','x'=>3,'y'=>37,'width'=>5.5),
				...
				array('label'=>'House Location Map (Sketch from the nearest landmark)','x'=>0,'y'=>47.5,'width'=>30,'height'=>24),
				array('label'=>$timestamp,'x'=>0,'y'=>73,'width'=>30,'height'=>1, 'no_box'=>true)

		);
		return AdmissionInquiryForm1C::$_fields;
	}

	function setupData($fields,$student=null){
		...
		if($student):
			...
			$fields[18]['data']=$inquiry['g_first_name'].' '.$inquiry['g_last_name'];
			$fields[19]['data']=$inquiry['g_rel'];
			$fields[20]['data']=$inquiry['g_contact_no'];
		endif;
